...
hasNoSideEffect (PostIncrement _) = False
hasNoSideEffect (PostDecrement _) = False
hasNoSideEffect (PreIncrement _) = False
hasNoSideEffect (PreDecrement _) = False
