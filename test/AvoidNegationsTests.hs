  ...
  let expectedRange1 =
        Range
          { start = Position {line = 6, column = Just 9},
            end = Just (Position {line = 10, column = Just 10})
          }
  let expectedRange2 =
        Range
          { start = Position {line = 15, column = Just 9},
            end = Just (Position {line = 18, column = Just 37})
          }
  let expectedRange3 =
        Range
          { start = Position {line = 22, column = Just 9},
            end = Just (Position {line = 28, column = Just 10})
          }
  let expectedRange4 =
        Range
  ...
  let expectedRange5 =
        Range
          { start = Position {line = 50, column = Just 9},
            end = Just (Position {line = 54, column = Just 10})
          }
  let expectedRange6 =
        Range
          { start = Position {line = 60, column = Just 13},
            end = Just (Position {line = 64, column = Just 14})
          }
  let expectedRange7 =
        Range
