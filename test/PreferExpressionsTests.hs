  ...
  let expectedRange1 =
        Range
          { start = Position {line = 7, column = Just 13},
            end = Just (Position {line = 8, column = Just 22})
          }
  let expectedRange2 =
        Range
          { start = Position {line = 8, column = Just 13},
            end = Just (Position {line = 9, column = Just 48})
          }
  let expectedRange3 =
        Range
          { start = Position {line = 9, column = Just 13},
            end = Just (Position {line = 10, column = Just 49})
          }
  let expectedRange4 =
        Range
  ...
  let expectedRange5 =
        Range
          { start = Position {line = 19, column = Just 13},
            end = Just (Position {line = 20, column = Just 50})
          }
  let expectedRange6 =
        Range
          { start = Position {line = 20, column = Just 13},
            end = Just (Position {line = 21, column = Just 51})
          }
  let expectedRange7 =
        Range
          { start = Position {line = 21, column = Just 13},
            end = Just (Position {line = 22, column = Just 23})
          }
  let expectedRange8 =
        Range
  ...
  let expectedRange9 =
        Range
          { start = Position {line = 32, column = Just 13},
            end = Just (Position {line = 33, column = Just 51})
          }
  let expectedRange10 =
        Range
          { start = Position {line = 33, column = Just 13},
            end = Just (Position {line = 34, column = Just 23})
          }
  let expectedRange11 =
        Range
  ...
  let expectedRange12 =
        Range
          { start = Position {line = 43, column = Just 13},
            end = Just (Position {line = 44, column = Just 53})
          }
  let expectedRange13 =
        Range
          { start = Position {line = 44, column = Just 13},
            end = Just (Position {line = 45, column = Just 54})
          }
  let expectedRange14 =
        Range
  ...
  let expectedRange15 =
        Range
          { start = Position {line = 55, column = Just 13},
            end = Just (Position {line = 56, column = Just 23})
          }
  let expectedRange16 =
        Range
  ...
  let expectedRange17 =
        Range
          { start = Position {line = 78, column = Just 13},
            end = Just (Position {line = 78, column = Just 26})
          }
  let expectedRange18 =
        Range
          { start = Position {line = 102, column = Just 13},
            end = Just (Position {line = 102, column = Just 63})
          }
  let expectedRanges =
        [ expectedRange1,
          expectedRange2,
